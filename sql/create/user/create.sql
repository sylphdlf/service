...
CREATE TABLE IF NOT EXISTS u_access_log (
  ...
  session_id VARCHAR(50) NULL COMMENT 'session',
  url VARCHAR(100) NOT NULL COMMENT '访问接口',
  access_count integer(11) NOT NULL COMMENT '访问次数',
...
CREATE TABLE IF NOT EXISTS u_access_refuse (
  id BIGINT(20) NOT NULL AUTO_INCREMENT,
  user_id BIGINT(20) NOT NULL COMMENT '用户id',
  ip_addr VARCHAR(20) NOT NULL COMMENT '访问ip',
  refuse_time Integer(11) NOT NULL COMMENT '禁止访问时间(分钟),0为永久',
  create_user_id BIGINT(20) NULL COMMENT '创建人',
  create_time TIMESTAMP DEFAULT current_timestamp COMMENT '创建时间',
  update_user_id BIGINT(20) NULL COMMENT '最后修改人',
  update_time TIMESTAMP NULL DEFAULT NULL COMMENT '最后修改时间',
  ...
  is_deleted INT(2) DEFAULT '0' COMMENT '是否逻辑删除:默认0未删除,1已删除',
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COMMENT='访问黑名单';